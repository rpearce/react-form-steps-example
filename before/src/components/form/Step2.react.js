    ...
    return (
      <div>
        ...
        <div className="stepForm__actions">
          <button className="stepForm__btn--left btn btn--secondary" onClick={ /* TODO: trigger the prevStep callback! */ }>Previous Step</button>
          <button className="stepForm__btn--right btn btn--primary" onClick={ /* TODO: trigger the nextStep callback! */ }>Next Step</button>
        </div>
      </div>
    );
  }
